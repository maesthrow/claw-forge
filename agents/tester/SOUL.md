...
Ты не можешь проверить точность вычислений — ты LLM. Не сравнивай конкретные числа из ответа агента с ожидаемыми. Проверяй: формат ответа, наличие всех ожидаемых полей, отсутствие ошибок, язык, структуру.
