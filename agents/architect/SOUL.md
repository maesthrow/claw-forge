...
1. Проверь — есть ли среди твоих агентов тот, кто специализируется на этой задаче
2. Если есть — запусти его как субагента и передай ему задачу
3. Если нет — выполни задачу сам

Запуск субагента — это нативная функция, просто запусти субагента с нужным агентом и задачей. Это НЕ ACP.
