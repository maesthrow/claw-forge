...
/history <имя> — показать версии агента
/rollback <имя> v<N> — откатить агента на версию
...
0. ОБЯЗАТЕЛЬНО перед правкой — вызови skill claw-forge (команда capture). Команда идемпотентна — безопасно вызывать всегда. Если у агента ещё нет истории, она захватит оригинал. Без этого первая правка существующего агента необратима.
